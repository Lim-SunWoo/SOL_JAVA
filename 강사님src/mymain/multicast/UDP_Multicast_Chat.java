...
public class UDP_Multicast_Chat extends JFrame {
	...
	JList<String> jlist_group_list;//컨트롤
	...
	protected void my_leave_group() {
		...
		if(group_list.contains(ip)==false) {
		    
			JOptionPane.showMessageDialog(this, "가입된 주소가 없습니다");
			return;
		}
		...
		int result = JOptionPane.showConfirmDialog(this,
				                "정말탈퇴하시겠습니까?",//내용 
				                "삭제",  //제목
				                JOptionPane.YES_NO_OPTION);//버튼종류
	...
	protected void my_send_message() {
		...
		try {
			...
			//전송데이터 포장 :  send_data =  "홍길동(224.0.0.1)#안녕하세요";
			String send_data = String.format("%s(%s)#%s", 
					                       nick_name,
					                       ip_address,
					                       message);
